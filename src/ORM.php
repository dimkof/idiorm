...
use \Idiorm\ORMResultSet;
use \Idiorm\ORMString;
...
class ORM implements ArrayAccess {
	...
	{
		if (!is_object(static::$_db[$connection_name])) {
	...
	*/
	...
	public static function get_last_query($connection_name = null) {
		...
		return implode('', array_slice(static::$_query_log[$connection_name], -1));
	...
	public function find_result_set() {
		return new ORMResultSet($this->_find_many());
	}
